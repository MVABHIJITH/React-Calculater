    ...
    <>
      <div style={{ width: '100%', height: '100vh' }} className='d-flex align-items-center justify-content-center'>
        <div style={{ width: '450px', height: '600px' }} className='box d-flex align-items-center justify-content-center'>
          <div style={{ width: '380px', height: '540px', paddingLeft: '25px', backgroundColor: ' rgb(60, 58, 58)', borderRadius: '30px' }}
            className=' border border-dark d-flex flex-column  '>


            <div style={{ marginTop: '30px', marginLeft: '5px' }} >
              <input type="text" style={{
                width: '320px', height: '90px', paddingLeft: '10px', backgroundColor: '#242323', fontSize: '40px', color: 'white',
                border: '1px solid #121212'
              }}
                className="input  border border-dark rounded " value={display} readOnly />
            </div>
